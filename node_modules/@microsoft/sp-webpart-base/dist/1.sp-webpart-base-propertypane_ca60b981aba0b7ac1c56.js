webpackJsonp974a7777_0990_4136_8fa6_95d80114c2e0_0_0_1([1],Array(41).concat([
/* 41 */
/***/ function(module, exports, __webpack_require__) {
	...
	var sp_client_base_1 = __webpack_require__(40);
	var PropertyPaneDefinitions_1 = __webpack_require__(2);
	var PropertyPanePage_1 = __webpack_require__(42);
	var PropertyPaneTitleBar_1 = __webpack_require__(52);
	var PropertyPaneFooter_1 = __webpack_require__(59);
	var Strings_resx_1 = __webpack_require__(36);
	var PropertyPane_module_scss_1 = __webpack_require__(53);
	var PropertyPanePage_module_scss_1 = __webpack_require__(49);
	var office_ui_fabric_react_1 = __webpack_require__(28);
	var CanvasA11y_1 = __webpack_require__(63);
	var PageDirection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(26);
	var office_ui_fabric_react_1 = __webpack_require__(28);
	var PropertyPaneGroup_1 = __webpack_require__(43);
	var PropertyPanePage_module_scss_1 = __webpack_require__(49);
	var PropertyPanePage = (function (_super) {
	    __extends(PropertyPanePage, _super);
	    ...
	    PropertyPanePage.prototype.render = function () {
	        var _this = this;
	        var index = 0;
	        var propertyGroups = this.props.propertyGroups.map(function (group) { return (React.createElement(PropertyPaneGroup_1.default, { key: group.groupName || index++, groupName: group.groupName, groupFields: group.groupFields, onChange: _this.props.onChange, properties: _this.props.properties, setEntryState: _this.props.setEntryState, displayGroupsAsAccordion: _this.props.displayGroupsAsAccordion })); });
	        return (React.createElement("div", { ref: function (c) { return _this._propertyPanePage = c; } },
	            this.props.pageDescription
	                ? React.createElement("div", { className: office_ui_fabric_react_1.css(PropertyPanePage_module_scss_1.default.propertyPanePageDescription, 'ms-font-m-plus'), id: 'propertyPaneDescriptionId' }, this.props.pageDescription)
	                : null,
	            propertyGroups));
	    };
	    return PropertyPanePage;
	}(React.Component));
	PropertyPanePage = __decorate([
	    decorators_1.sealed
	], PropertyPanePage);
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PropertyPaneCustomFieldHost_1 = __webpack_require__(44);
	var office_ui_fabric_react_1 = __webpack_require__(28);
	var IPropertyPaneField_1 = __webpack_require__(45);
	var PropertyPaneGroup_module_scss_1 = __webpack_require__(46);
	    ...
	    PropertyPaneGroup.prototype._renderGroupField = function (groupField) {
	        ...
	        switch (groupField.type) {
	            case IPropertyPaneField_1.PropertyPaneFieldType.Custom:
	                groupFieldElement = React.createElement(PropertyPaneCustomFieldHost_1.default, __assign({}, groupField.properties));
	                break;
	            case IPropertyPaneField_1.PropertyPaneFieldType.Toggle:
	                groupFieldElement =
	                    React.createElement(office_ui_fabric_react_1.Toggle, __assign({}, groupField.properties, { ref: setRef, checked: propValue, onText: groupField.properties.onText || 'On', offText: groupField.properties.offText || 'Off', onChanged: function (value) {
	                            _this._onChange(groupField, value);
	                        } }));
	                break;
	            case IPropertyPaneField_1.PropertyPaneFieldType.TextField:
	                groupFieldElement = React.createElement(office_ui_fabric_react_1.TextField, __assign({}, groupField.properties, { ref: setRef, value: propValue ? propValue : '', onChanged: function (value) {
	                        _this._onChange(groupField, value);
	            ...
	            case IPropertyPaneField_1.PropertyPaneFieldType.Dropdown:
	                groupFieldElement = React.createElement(office_ui_fabric_react_1.Dropdown, __assign({}, groupField.properties, { ref: setRef, selectedKey: propValue || groupField.properties.selectedKey, disabled: groupField.properties.isDisabled || groupField.properties.disabled, label: groupField.properties.label, onChanged: function (option, index) {
	                        _this._onDropDownChange(groupField, option, index);
	                    } }));
	                break;
	            case IPropertyPaneField_1.PropertyPaneFieldType.CheckBox:
	                groupFieldElement = React.createElement(office_ui_fabric_react_1.Checkbox, __assign({}, groupField.properties, { ref: setRef, label: groupField.properties.text, checked: propValue, disabled: this._isDisabled(groupField), onChange: function (ev, isChecked) {
	            ...
	            case IPropertyPaneField_1.PropertyPaneFieldType.Slider:
	                groupFieldElement =
	                    React.createElement(office_ui_fabric_react_1.Slider, __assign({}, groupField.properties, { ref: setRef, value: propValue, onChange: function (value) {
	                            _this._onChange(groupField, value);
	                        } }));
	                break;
	            case IPropertyPaneField_1.PropertyPaneFieldType.ChoiceGroup:
	                groupField.properties.options.forEach(function (option) {
	                    if (option.key === propValue) {
	                        option.isChecked = true;
	                    }
	                    if (option.hasOwnProperty('isDisabled') && option.isDisabled !== undefined) {
	                        option.disabled = option.isDisabled;
	                    }
	                });
	                groupFieldElement =
	                    React.createElement(office_ui_fabric_react_1.ChoiceGroup, __assign({}, groupField.properties, { ref: setRef, options: groupField.properties.options, className: PropertyPaneGroup_module_scss_1.default.propertyPaneChoiceGroup, onChanged: function (checkedOption) {
	            ...
	            case IPropertyPaneField_1.PropertyPaneFieldType.Button:
	                ...
	                groupFieldElement =
	                    React.createElement(office_ui_fabric_react_1.Button, __assign({}, groupField.properties, { ref: setRef, onClick: handleClick, ariaLabel: groupField.properties.text }), groupField.properties.text);
	                break;
	            ...
	            case IPropertyPaneField_1.PropertyPaneFieldType.Link:
	                groupFieldElement = React.createElement(office_ui_fabric_react_1.Link, __assign({ ref: setRef }, groupField.properties), groupField.properties.text);
	                break;
	            default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PropertyPaneCustomFieldHost = (function (_super) {
	    ...
	    PropertyPaneCustomFieldHost.prototype.componentDidMount = function () {
	        ...
	        this.props.onRender(this._domElement, this.props.context);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styles = {
	    propertyPaneGroupHeader: 'propertyPaneGroupHeader_46d5d045',
	    propertyPaneGroup: 'propertyPaneGroup_46d5d045',
	    isExpanded: 'isExpanded_46d5d045',
	    propertyPaneGroupContent: 'propertyPaneGroupContent_46d5d045',
	    propertyPaneGroupHeaderText: 'propertyPaneGroupHeaderText_46d5d045',
	    propertyPaneGroupHeaderIcon: 'propertyPaneGroupHeaderIcon_46d5d045',
	    propertyPaneGroupHeaderWithAccordion: 'propertyPaneGroupHeaderWithAccordion_46d5d045',
	    propertyPaneGroupHeaderNoAccordion: 'propertyPaneGroupHeaderNoAccordion_46d5d045',
	    propertyPaneChoiceGroup: 'propertyPaneChoiceGroup_46d5d045',
	    propertyPaneGroupField: 'propertyPaneGroupField_46d5d045',
	};
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".propertyPaneGroupHeader_46d5d045{background:0 0;border-top:1px solid #eaeaea;color:#333;cursor:pointer;font-weight:600;font-size:14px;height:40px;line-height:40px;width:100%;padding:0 8px}[dir=ltr] .propertyPaneGroupHeader_46d5d045{text-align:left}[dir=rtl] .propertyPaneGroupHeader_46d5d045{text-align:right}.propertyPaneGroup_46d5d045:last-child .propertyPaneGroupHeader_46d5d045{border-bottom:1px solid #eaeaea}.propertyPaneGroupHeader_46d5d045 .ms-Icon{color:#767676;font-size:14px;line-height:38px;position:relative}[dir=ltr] .propertyPaneGroupHeader_46d5d045 .ms-Icon{padding-right:4px}[dir=rtl] .propertyPaneGroupHeader_46d5d045 .ms-Icon{padding-left:4px}.propertyPaneGroup_46d5d045.isExpanded_46d5d045 .propertyPaneGroupContent_46d5d045{display:block}.propertyPaneGroupHeaderText_46d5d045{vertical-align:top;line-height:38px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap}[dir=ltr] .propertyPaneGroupHeaderText_46d5d045{margin-right:20}[dir=rtl] .propertyPaneGroupHeaderText_46d5d045{margin-left:20}[dir=ltr] .propertyPaneGroupHeaderIcon_46d5d045{float:left}[dir=rtl] .propertyPaneGroupHeaderIcon_46d5d045{float:right}.propertyPaneGroupHeader_46d5d045{border-bottom:1px solid #eaeaea}[dir=ltr] .propertyPaneGroupHeader_46d5d045{border-right:1px solid #eaeaea}[dir=rtl] .propertyPaneGroupHeader_46d5d045{border-left:1px solid #eaeaea}.propertyPaneGroupHeaderWithAccordion_46d5d045{padding:4px 0}.propertyPaneGroupHeaderNoAccordion_46d5d045{color:#333;font-weight:600;font-size:14px;height:40px;line-height:40px;padding-top:4px;width:300px;text-overflow:ellipsis;overflow:hidden}[dir=ltr] .propertyPaneGroupHeaderNoAccordion_46d5d045{padding-right:0}[dir=rtl] .propertyPaneGroupHeaderNoAccordion_46d5d045{padding-left:0}[dir=ltr] .propertyPaneGroupHeaderNoAccordion_46d5d045{padding-left:20px}[dir=rtl] .propertyPaneGroupHeaderNoAccordion_46d5d045{padding-right:20px}[dir=ltr] .propertyPaneGroupHeaderNoAccordion_46d5d045{text-align:left}[dir=rtl] .propertyPaneGroupHeaderNoAccordion_46d5d045{text-align:right}.propertyPaneGroupContent_46d5d045{padding:0 20px 16px 20px}.propertyPaneGroupContent_46d5d045 h2{font-size:15px;color:#333;font-weight:600;font-weight:400}.propertyPaneGroupContent_46d5d045 .ms-TextField.ms-TextField--multiline .ms-TextField-field{min-height:140px;resize:vertical}.propertyPaneChoiceGroup_46d5d045 .ms-ChoiceField-field--image{min-width:132px;padding:20px 0 12px 0}[dir=rtl] .propertyPaneChoiceGroup_46d5d045 .ms-ChoiceField-field--image{padding:20px 0 12px 0}.propertyPaneChoiceGroup_46d5d045 .ms-ChoiceField-field--image .ms-Image{display:inline-block}.propertyPaneGroupField_46d5d045{padding-top:4px}.propertyPaneGroupField_46d5d045 a.ms-Link{font-size:14px;margin-bottom:16px}@media screen and (-ms-high-contrast:active){.propertyPaneGroupField_46d5d045 a.ms-Link:hover{text-decoration:underline}}@media screen and (-ms-high-contrast:white-on-black){.propertyPaneGroupField_46d5d045 a.ms-Link{color:#FF0}}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styles = {
	    propertyPaneTitleBarBox: 'propertyPaneTitleBarBox_7592fef2',
	    propertyPaneTitleBar: 'propertyPaneTitleBar_7592fef2',
	    propertyPanePageTitle: 'propertyPanePageTitle_7592fef2',
	    propertyPaneClose: 'propertyPaneClose_7592fef2',
	    propertyPanePageContent: 'propertyPanePageContent_7592fef2',
	    propertyPanePageDescription: 'propertyPanePageDescription_7592fef2',
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = styles;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".propertyPaneTitleBarBox_7592fef2{position:absolute;width:100%;top:0;padding-bottom:20px}.propertyPaneTitleBar_7592fef2{background:#3C3C3C;padding:10px 20px 12px;height:25px}.propertyPanePageTitle_7592fef2{line-height:1.2}[dir=ltr] .propertyPanePageTitle_7592fef2{margin-right:20px}[dir=rtl] .propertyPanePageTitle_7592fef2{margin-left:20px}.propertyPaneClose_7592fef2{background-color:transparent;border:none;color:#fff;cursor:pointer;font-size:20px;padding:0 20px;position:absolute;top:13px;min-width:0}[dir=ltr] .propertyPaneClose_7592fef2{right:0}[dir=rtl] .propertyPaneClose_7592fef2{left:0}.propertyPanePageContent_7592fef2{position:absolute;width:100%;top:67px;bottom:0;overflow-x:hidden;overflow-y:auto}.propertyPanePageDescription_7592fef2{padding:0 20px 16px 20px;color:#333;font-size:14px}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Strings_resx_1 = __webpack_require__(36);
	var PropertyPane_module_scss_1 = __webpack_require__(53);
	var PropertyPaneTitleBar_module_scss_1 = __webpack_require__(56);
	var PropertyPaneTitleBar = (function (_super) {
	    __extends(PropertyPaneTitleBar, _super);
	    function PropertyPaneTitleBar() {
	        return _super !== null && _super.apply(this, arguments) || this;
	    }
	    PropertyPaneTitleBar.prototype.render = function () {
	        return (React.createElement("div", { className: PropertyPaneTitleBar_module_scss_1.default.propertyPaneTitleBarBox },
	            React.createElement("div", { className: PropertyPaneTitleBar_module_scss_1.default.propertyPaneTitleBar },
	                React.createElement("div", { className: office_ui_fabric_react_1.css(PropertyPaneTitleBar_module_scss_1.default.propertyPanePageTitle, 'ms-font-xl', 'ms-fontColor-white') }, this.props.title),
	                React.createElement("div", { className: PropertyPane_module_scss_1.default.propertyPaneScreenReaderOnly, id: 'propertyPaneTitleId' }, sp_core_library_1.Text.format(Strings_resx_1.default.PropertyPaneTitle, this.props.title)),
	                React.createElement("button", { tabIndex: this.props.title ? 0 : -1, className: PropertyPaneTitleBar_module_scss_1.default.propertyPaneClose, onClick: this.props.onClose, "aria-label": Strings_resx_1.default.Close },
	                    React.createElement("i", { className: office_ui_fabric_react_1.css('ms-Icon', 'ms-Icon--Cancel') })))));
	    };
	    return PropertyPaneTitleBar;
	}(React.Component));
	PropertyPaneTitleBar = __decorate([
	    decorators_1.sealed
	], PropertyPaneTitleBar);
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = PropertyPaneTitleBar;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styles = {
	    propertyPane: 'propertyPane_29ffb37b',
	    propertyPaneDescription: 'propertyPaneDescription_29ffb37b',
	    propertyPaneScreenReaderOnly: 'propertyPaneScreenReaderOnly_29ffb37b',
	    twoRowFooter: 'twoRowFooter_29ffb37b',
	    oneRowFooter: 'oneRowFooter_29ffb37b',
	    overlay: 'overlay_29ffb37b',
	    spinner: 'spinner_29ffb37b',
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = styles;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".propertyPane_29ffb37b{top:0;bottom:0;position:absolute;background-color:#fff;width:340px;-webkit-font-smoothing:antialiased}html[dir=ltr] .propertyPane_29ffb37b{border-left:1px solid #eaeaea}html[dir=rtl] .propertyPane_29ffb37b{border-right:1px solid #eaeaea}html[dir=ltr] .propertyPane_29ffb37b{right:0}html[dir=rtl] .propertyPane_29ffb37b{left:0}.propertyPaneDescription_29ffb37b{padding:0 20px;color:#333;font-size:14px}.propertyPaneScreenReaderOnly_29ffb37b{position:absolute;text-indent:-9999px;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;border:0}.twoRowFooter_29ffb37b{bottom:104px}.oneRowFooter_29ffb37b{bottom:70px}.overlay_29ffb37b{height:100%;width:340px;z-index:1}.spinner_29ffb37b{top:50%;position:relative}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styles = {
	    propertyPaneTitleBarBox: 'propertyPaneTitleBarBox_86bc3e97',
	    propertyPaneTitleBar: 'propertyPaneTitleBar_86bc3e97',
	    propertyPanePageTitle: 'propertyPanePageTitle_86bc3e97',
	    propertyPaneClose: 'propertyPaneClose_86bc3e97',
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = styles;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".propertyPaneTitleBarBox_86bc3e97{position:absolute;width:100%;top:0;padding-bottom:20px}.propertyPaneTitleBar_86bc3e97{background:#3C3C3C;padding:10px 20px 12px;height:25px}.propertyPanePageTitle_86bc3e97{line-height:1.2}[dir=ltr] .propertyPanePageTitle_86bc3e97{margin-right:20px}[dir=rtl] .propertyPanePageTitle_86bc3e97{margin-left:20px}.propertyPaneClose_86bc3e97{background-color:transparent;border:none;color:#fff;cursor:pointer;font-size:20px;padding:0 20px;position:absolute;top:13px;min-width:0}[dir=ltr] .propertyPaneClose_86bc3e97{right:0}[dir=rtl] .propertyPaneClose_86bc3e97{left:0}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var office_ui_fabric_react_1 = __webpack_require__(28);
	var Strings_resx_1 = __webpack_require__(36);
	var PropertyPaneFooter_module_scss_1 = __webpack_require__(60);
	var PropertyPane_1 = __webpack_require__(41);
	var PropertyPaneFooter = (function (_super) {
	    __extends(PropertyPaneFooter, _super);
	    ...
	    PropertyPaneFooter.prototype._renderCommandButtons = function () {
	        return ((this.props.isReactive === false) && (React.createElement("div", { className: this.props.numberOfPages > 1 ? PropertyPaneFooter_module_scss_1.default.propertyPaneCommandButtonsBox : undefined },
	            React.createElement("button", { className: 'ms-Button ms-Button--primary', disabled: !this.props.isSaveButtonEnabled, onClick: this.props.onSaveClick },
	                React.createElement("span", { className: 'ms-Button-label' }, Strings_resx_1.default.Save))))); 
	    };
	    PropertyPaneFooter.prototype._pageNavigationButtons = function () {
	        ...
	        return (this.props.numberOfPages > 1 && (React.createElement("div", { className: PropertyPaneFooter_module_scss_1.default.propertyPanePageNav },
	            React.createElement("button", { className: PropertyPaneFooter_module_scss_1.default.propertyPaneBackNavLink, disabled: this.props.currentPage === 1, onClick: function () { _this.props.onFlipPage(PropertyPane_1.PageDirection.back); } },
	                React.createElement("i", { className: office_ui_fabric_react_1.css(this._arrowKeyIcon(PropertyPane_1.PageDirection.back), PropertyPaneFooter_module_scss_1.default.propertyPaneBackArrow) }),
	                Strings_resx_1.default.PropertyPaneBackPage),
	            React.createElement("span", { role: 'status', className: office_ui_fabric_react_1.css(PropertyPaneFooter_module_scss_1.default.propertyPanePageOfPages) }, sp_core_library_1.Text.format(Strings_resx_1.default.PropertyPanePageOfPages, this.props.currentPage, this.props.numberOfPages)),
	            React.createElement("button", { className: PropertyPaneFooter_module_scss_1.default.propertyPaneNextNavLink, disabled: this.props.currentPage === this.props.numberOfPages, onClick: function () { _this.props.onFlipPage(PropertyPane_1.PageDirection.next); } },
	                Strings_resx_1.default.PropertyPaneNextPage,
	                React.createElement("i", { className: office_ui_fabric_react_1.css(this._arrowKeyIcon(PropertyPane_1.PageDirection.next), PropertyPaneFooter_module_scss_1.default.propertyPaneNextArrow) }))))); 
	    };
	    PropertyPaneFooter.prototype._arrowKeyIcon = function (dir) {
	        var rtl = document.dir === 'rtl';
	        var iconCSS = 'ms-Icon ms-Icon--Chevron';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styles = {
	    propertyPaneFooter: 'propertyPaneFooter_6e42fd11',
	    propertyPaneCommandButtonsBox: 'propertyPaneCommandButtonsBox_6e42fd11',
	    propertyPanePageNav: 'propertyPanePageNav_6e42fd11',
	    propertyPaneBackNavLink: 'propertyPaneBackNavLink_6e42fd11',
	    propertyPaneNextNavLink: 'propertyPaneNextNavLink_6e42fd11',
	    propertyPaneBackArrow: 'propertyPaneBackArrow_6e42fd11',
	    propertyPaneNextArrow: 'propertyPaneNextArrow_6e42fd11',
	    propertyPanePageOfPages: 'propertyPanePageOfPages_6e42fd11',
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = styles;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".propertyPaneFooter_6e42fd11{background-color:#fff;position:absolute;bottom:0;left:0;padding:20px;right:0}.propertyPaneCommandButtonsBox_6e42fd11{padding-bottom:20px}.propertyPanePageNav_6e42fd11{-webkit-box-align:baseline;-ms-flex-align:baseline;align-items:baseline;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between}.propertyPaneBackNavLink_6e42fd11,.propertyPaneNextNavLink_6e42fd11{background-color:transparent;border:0;color:#333;font-weight:400;font-size:14px;font-weight:400;height:32px;outline:0;padding:0}.propertyPaneBackNavLink_6e42fd11 .propertyPaneBackArrow_6e42fd11,.propertyPaneBackNavLink_6e42fd11 .propertyPaneNextArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11 .propertyPaneBackArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11 .propertyPaneNextArrow_6e42fd11{color:#0078d7;position:relative;top:2px}[dir=ltr] .propertyPaneBackNavLink_6e42fd11 .propertyPaneBackArrow_6e42fd11,[dir=ltr] .propertyPaneNextNavLink_6e42fd11 .propertyPaneBackArrow_6e42fd11{margin-right:4px}[dir=rtl] .propertyPaneBackNavLink_6e42fd11 .propertyPaneBackArrow_6e42fd11,[dir=rtl] .propertyPaneNextNavLink_6e42fd11 .propertyPaneBackArrow_6e42fd11{margin-left:4px}[dir=ltr] .propertyPaneBackNavLink_6e42fd11 .propertyPaneNextArrow_6e42fd11,[dir=ltr] .propertyPaneNextNavLink_6e42fd11 .propertyPaneNextArrow_6e42fd11{margin-left:4px}[dir=rtl] .propertyPaneBackNavLink_6e42fd11 .propertyPaneNextArrow_6e42fd11,[dir=rtl] .propertyPaneNextNavLink_6e42fd11 .propertyPaneNextArrow_6e42fd11{margin-right:4px}.propertyPaneBackNavLink_6e42fd11:disabled,.propertyPaneNextNavLink_6e42fd11:disabled{color:#a6a6a6}.propertyPaneBackNavLink_6e42fd11:disabled .propertyPaneBackArrow_6e42fd11,.propertyPaneBackNavLink_6e42fd11:disabled .propertyPaneNextArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11:disabled .propertyPaneBackArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11:disabled .propertyPaneNextArrow_6e42fd11{color:#a6a6a6}.propertyPaneBackNavLink_6e42fd11:not(:disabled):active,.propertyPaneBackNavLink_6e42fd11:not(:disabled):focus,.propertyPaneBackNavLink_6e42fd11:not(:disabled):hover,.propertyPaneNextNavLink_6e42fd11:not(:disabled):active,.propertyPaneNextNavLink_6e42fd11:not(:disabled):focus,.propertyPaneNextNavLink_6e42fd11:not(:disabled):hover{background-color:#b3d6f2;color:#0078d7;cursor:pointer}.propertyPaneBackNavLink_6e42fd11:not(:disabled):active .propertyPaneBackArrow_6e42fd11,.propertyPaneBackNavLink_6e42fd11:not(:disabled):active .propertyPaneNextArrow_6e42fd11,.propertyPaneBackNavLink_6e42fd11:not(:disabled):focus .propertyPaneBackArrow_6e42fd11,.propertyPaneBackNavLink_6e42fd11:not(:disabled):focus .propertyPaneNextArrow_6e42fd11,.propertyPaneBackNavLink_6e42fd11:not(:disabled):hover .propertyPaneBackArrow_6e42fd11,.propertyPaneBackNavLink_6e42fd11:not(:disabled):hover .propertyPaneNextArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11:not(:disabled):active .propertyPaneBackArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11:not(:disabled):active .propertyPaneNextArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11:not(:disabled):focus .propertyPaneBackArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11:not(:disabled):focus .propertyPaneNextArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11:not(:disabled):hover .propertyPaneBackArrow_6e42fd11,.propertyPaneNextNavLink_6e42fd11:not(:disabled):hover .propertyPaneNextArrow_6e42fd11{color:#005a9e}.propertyPanePageOfPages_6e42fd11{margin-top:6px}", ""]);
...
//# sourceMappingURL=1.sp-webpart-base-propertypane_ca60b981aba0b7ac1c56.js.map