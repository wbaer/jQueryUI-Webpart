define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "EnvironmentType жарамсыз",
      "invalidGuidStringError": "GUID жолы жарамсыз: \"{0}\"",
      "isFalseValidateError": "\"{0}\" параметрінің мәні жалған",
      "isNullValidateError": "\"{0}\" параметрінің мәні null болмауы тиіс",
      "isUndefinedValidateError": "\"{0}\" параметрі мәні анықталмаған болмауы тиіс",
      "isEmptyStringValidateError": "\"{0}\" параметрінің мәні бос жол болмауы тиіс",
      "invalidVersionStringError": "Нұсқа жолы жарамсыз: \"{0}\"",
      "logVerboseLevelMessage": "{0}: ТОЛЫҚ {1}",
      "logInfoLevelMessage": "{0}: {1}",
      "logWarningLevelMessage": "{0}: ЕСКЕРТУ {1}",
      "logErrorLevelMessage": "{0}: ҚАТЕ: {1}",
      "serviceScopeConsumingBeforeFinished": "Қызметтерді пайдалану мүмкін емес, себебі аумақ әлі аяқталмады",
      "serviceScopeConsumingDuringAutoCreation": "ServiceScope опциясын автоматты түрде жасау кезінде қызметтерді пайдалану мүмкін емес",
      "serviceScopeAlreadyFinishedError": "ServiceScope бұрыннан аяқталған",
      "serviceScopeProvideServiceAfterFinishedError": "Қызметті тіркеу мүмкін емес, себебі аумақ аяқталып қойды",
      "serviceScopeProvideServiceThatAlreadyExists": "\"{0}\" қызмет кілті бұл аумақта бұрыннан тіркелген"
    },
    "_nQNACBeQ34aV6bVwtFBayA": {
      "platformFailedToLoadError": "Платформаны жүктеу сәтсіз аяқталды. Ид.: \"{0}\", аты: \"{1}\"",
      "applicationFailedToLoadError": "Бағдарламаны жүктеу мүмкін болмады. Ид.: \"{0}\", аты: \"{1}\"",
      "applicationFailedToLoadWithMessageError": "Бағдарламаны жүктеу мүмкін болмады. Ид.: \"{0}\", аты: \"{1}\", қате: {2}",
      ...
      "missingApplicationIdError": "Бағдарлама идентификаторы жоқ.",
      ...
      "debugManifestLoadingWarning": "ЕСКЕРТУ: Бұл бет компьютеріңізге зиян келтіруі мүмкін қауіпті сценарийлерді жүктеуге сұрау жіберуде! Әзірлеушіге сенбесеңіз және төнетін қатерлердің қаншалықты қауіпті екенін білмесеңіз, процесті жалғастырмаңыз.",
      ...
      "loadComponentError": "\"{0}\" ({1}) компонентін жүктеу сәтсіз аяқталды. Бастапқы қате: {2}",
      ...
      "loadComponentDependencyFailoverPathError": "\"{2}\" ({3}) компонентіндегі \"{1}\" ақаулығын өңдеу жолы арқылы \"{0}\" тәуелділігін жүктеу сәтсіз аяқталды.",
      ...
      "loadEntryPointError": "\"{0}\" ({1}) компонентінен кіріс нүктесін жүктеу мүмкін болмады.",
