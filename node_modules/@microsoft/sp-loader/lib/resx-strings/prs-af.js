define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "EnvironmentType نامعتبر است",
      "invalidGuidStringError": "رشته GUID نامعتبر: \"{0}\"",
      "isFalseValidateError": "مقدار برای \"{0}\" غلط است",
      "isNullValidateError": "مقدار برای \"{0}\" نباید خالی باشد",
      ...
      "logVerboseLevelMessage": "{0}:‌ دراز {1}",
      "logInfoLevelMessage": "{0}: {1}",
      "logWarningLevelMessage": "{0}:‌هشدار {1}",
      "logErrorLevelMessage": "{0}:‌خطا:‌{1}",
      "serviceScopeConsumingBeforeFinished": "خدمات را مصرف نمی تواند بخاطر که ساحه تحت پوشش تا هنوز ختم نشده",
      "serviceScopeConsumingDuringAutoCreation": "خدمات را در جریان ایجاد خودکار ServiceScope مصرف نمی تواند",
      "serviceScopeAlreadyFinishedError": "ServiceScope قبلا ختم شده است",
      "serviceScopeProvideServiceAfterFinishedError": "خدمت را بخاطر که ساحه تحت پوشش قبلا ختم شده ثبت نمی تواند",
      "serviceScopeProvideServiceThatAlreadyExists": "کلید \"{0}\" خدمت قبلا در این ساحه تحت پوشش ثبت شده است"
    },
    "_nQNACBeQ34aV6bVwtFBayA": {
      "platformFailedToLoadError": "بارگذای پایگاه ناکام ماند. شناسه:‌ \"{0}\"، اسم:‌ \"{1}\"",
      "applicationFailedToLoadError": "بارگذاری برنامه ناکام ماند. شناسه:‌ \"{0}\"، اسم:‌ \"{1}\"",
      "applicationFailedToLoadWithMessageError": "بارگذاری برنامه ناکام ماند. شناسه:‌ \"{0}\"، اسم:‌\"{1}\"، خطا:‌ {2}",
      ...
      "missingApplicationIdError": "برنامه مفقود شده id.",
      ...
      "debugManifestLoadingWarning": "اخطار: این صفحه بارگذاری اسکرپت های غیر ایمن را درخواست می کند، که می توانند کامپیوتر شمار را آسیب برسانند! ادامه ندهید مگر اینکه انکشاف دهنده مورد اعتماد شما باشد و از خطرات آن آگاه باشید.",
      ...
      "loadComponentError": "ناکامی در بارگذاری جزء \"{0} ({1})\". خطای اصلی:‌{2}",
      "loadComponentMaxRetriesError": "اقدام به بارگذاری جزء \"{0}\" ({1}) {2} مرتبه بدون موفقیت شد.",
      "loadComponentDependencyError": "در بارگذاری وابستگی جز \"{0}\" از جز \"{1}\" ({2}) ناکام ماند.",
      "loadComponentDependencyFailoverPathError": "در بارگذاری وابستگی جز \"{0}\" با مسیر افزونگی \"{1}\" از جز \"{2}\" ({3}) ناکام ماند.",
      "loadPathDependencyLog": "در حال بارگذاری وابستگی مسیر \"{0}\" از جزء \"{1}\" ({2})",
      "loadPathDependencyError": "در بارگذاری وابستگی مسیر \"{0}\" از جز \"{1}\" ({2}) ناکام ماند.",
