define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "EnvironmentType が無効です",
      "invalidGuidStringError": "GUID の文字列 \"{0}\" が無効です",
      "isFalseValidateError": "\"{0}\" の値は False です",
      "isNullValidateError": "\"{0}\" の値を null 値にすることはできません",
      ...
      "logVerboseLevelMessage": "{0}: 詳細 {1}",
      "logInfoLevelMessage": "{0}: {1}",
      "logWarningLevelMessage": "{0}: 警告 {1}",
      "logErrorLevelMessage": "{0}: エラー: {1}",
      "serviceScopeConsumingBeforeFinished": "スコープがまだ完了していないため、サービスを使用することはできません。",
      "serviceScopeConsumingDuringAutoCreation": "ServiceScope の自動作成中にサービスを使用することはできません",
      "serviceScopeAlreadyFinishedError": "ServiceScope は既に完了しています",
      "serviceScopeProvideServiceAfterFinishedError": "スコープが既に完了しているため、サービスを登録できません",
      "serviceScopeProvideServiceThatAlreadyExists": "サービス キー \"{0}\" はこのスコープで既に登録されています"
    },
    "_nQNACBeQ34aV6bVwtFBayA": {
      "platformFailedToLoadError": "プラットフォームの読み込みに失敗しました。ID: \"{0}\"、名前: \"{1}\"",
      "applicationFailedToLoadError": "アプリケーションの読み込みに失敗しました。ID: \"{0}\"、名前: \"{1}\"",
      "applicationFailedToLoadWithMessageError": "アプリケーションの読み込みに失敗しました。ID: \"{0}\"、名前: \"{1}\"、エラー: {2}",
      "applicationFailedToInitializeError": "アプリケーションの初期化中にエラーが発生しました。エラー: {0}",
      "invalidPreloadedDataError": "プリロードのデータが無効です。",
      "missingApplicationIdError": "アプリケーション ID が見つかりません。",
      "manifestNotFoundByIdError": "コンポーネント ID \"{0}\" のマニフェストが見つかりませんでした。",
      "manifestNotFoundError": "コンポーネント ID \"{0}\" バージョン \"{1}\" のマニフェストは見つかりませんでした。",
      "debugManifestLoadingWarning": "警告: このページは、安全ではないスクリプトの読み込みを要求しています。このスクリプトは、お使いのコンピューターに損害を与える可能性があります。開発者を信頼しており、危険性を理解している場合を除いて、続けないでください。",
      ...
      "loadComponentError": "コンポーネント \"{0}\" ({1}) を読み込むことができませんでした。元のエラー: {2}",
