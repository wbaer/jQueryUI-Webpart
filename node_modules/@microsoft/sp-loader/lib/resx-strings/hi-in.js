define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "EnvironmentType अमान्य है",
      "invalidGuidStringError": "अमान्य GUID स्ट्रिंग: \"{0}\"",
      "isFalseValidateError": "\"{0}\" का मान गलत है",
      "isNullValidateError": "\"{0}\" का मान नल नहीं होना चाहिए",
      ...
      "logVerboseLevelMessage": "{0}: वर्बोज़ {1}",
      "logInfoLevelMessage": "{0}: {1}",
      "logWarningLevelMessage": "{0}: चेतावनी {1}",
      "logErrorLevelMessage": "{0}: त्रुटि: {1}",
      "serviceScopeConsumingBeforeFinished": "सेवाओं का उपभोग नहीं कर सकता क्योंकि स्कोप अभी तक समाप्त नहीं हुआ है",
      "serviceScopeConsumingDuringAutoCreation": "ServiceScope autocreation के दौरान सेवाओं का उपभोग नहीं कर सकता",
      "serviceScopeAlreadyFinishedError": "ServiceScope पहले ही समाप्त हो गया है",
      "serviceScopeProvideServiceAfterFinishedError": "सेवा पंजीकृत नहीं कर सकता, क्योंकि स्कोप पहले ही समाप्त हो गया है",
      "serviceScopeProvideServiceThatAlreadyExists": "सेवा कुंजी \"{0}\" इस स्कोप में पहले से पंजीकृत किया हो चुकी है"
    },
    "_nQNACBeQ34aV6bVwtFBayA": {
      "platformFailedToLoadError": "प्लेटफ़ॉर्म लोड होने में विफल रहा. Id: \"{0}\", नाम,: \"{1}\"",
      "applicationFailedToLoadError": "एप्लिकेशन लोड होने में विफल रहा. Id: \"{0}\" नाम: \"{1}\"",
      "applicationFailedToLoadWithMessageError": "एप्लिकेशन लोड होने में विफल रहा. Id: \"{0}\" नाम: \"{1}\", त्रुटि: {2}",
      ...
      "missingApplicationIdError": "गुम एप्लिकेशन id.",
      ...
      "debugManifestLoadingWarning": "चेतावनी: यह पृष्ठ असुरक्षित स्क्रिप्ट्स को लोड करने का अनुरोध कर रहा है, जिससे आपके कंप्यूटर को नुकसान पहुँच सकता है! जब तक आपको डेवलपर पर विश्वास न हो, तब तक आगे न बढ़ें और जोख़िमों को समझें.",
      "debugManifestLoadingWarning2": "यदि आप आश्वस्त नहीं हैं, तो \"{0}\" क्लिक करें.",
      ...
      "loadComponentError": "घटक \"{0}\" लोड करना विफल रहा ({1}). मूल त्रुटि: {2}",
      "loadComponentMaxRetriesError": "बिना सफल हुए घटक \"{0}\" ({1}) को {2} बार लोड करने का प्रयास किया गया.",
      "loadComponentDependencyError": "\"{1}\" ({2}) घटक से घटक निर्भरता \"{0}\" लोड करने में विफल रहा.",
      "loadComponentDependencyFailoverPathError": "\"{2}\" ({3}) घटक से फ़ेलओवर पथ \"{1}\" के साथ घटक निर्भरता \"{0}\" लोड करने में विफल रहा.",
      "loadPathDependencyLog": "घटक \"{1}\" ({2}) से पथ निर्भरता \"{0}\" लोड कर रहा है",
      "loadPathDependencyError": "\"{1}\" ({2}) घटक से पथ निर्भरता \"{0}\" लोड करने में विफल रहा.",
      ...
      "loadEntryPointError": "\"{0}\" ({1}) घटक से प्रविष्टि बिंदु को लोड करने में विफल रहा.",
