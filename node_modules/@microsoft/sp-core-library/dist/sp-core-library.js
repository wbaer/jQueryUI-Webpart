define("7263c7d0-1d6a-45ec-8d85-d4d1d234171b_0.1.0", ["@microsoft/sp-lodash-subset"], function(__WEBPACK_EXTERNAL_MODULE_10__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ function(module, exports, __webpack_require__) {
	...
	var regex = new RegExp('sp-core-library_?[a-zA-Z0-9-_]*.js', 'i');
	var found = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Validate_1 = __webpack_require__(4);
	var Text_1 = __webpack_require__(5);
	var StringsProxy_1 = __webpack_require__(6);
	var Guid = (function () {
	    function Guid(guid) {
	        this._guid = guid;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var DefaultLogHandler_1 = __webpack_require__(18);
	var Log = (function () {
	    function Log() {
	    }
