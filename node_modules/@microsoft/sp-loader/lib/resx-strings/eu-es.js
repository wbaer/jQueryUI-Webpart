define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "EnvironmentType elementuak ez du balio",
      "invalidGuidStringError": "GUID kate honek ez du balio: \"{0}\"",
      "isFalseValidateError": "\"{0}\" balioa gezurra da",
      "isNullValidateError": "\"{0}\" balioak ezin du izan nulua",
      "isUndefinedValidateError": "\"{0}\" balioa ezin da egon definitu gabe",
      "isEmptyStringValidateError": "\"{0}\" balioa ezin da utzi hutsik",
      "invalidVersionStringError": "Bertsioaren kate honek ez du balio: \"{0}\"",
      "logVerboseLevelMessage": "{0}: XEHETASUNA {1}",
      "logInfoLevelMessage": "{0}: {1}",
      "logWarningLevelMessage": "{0}: ABISUA {1}",
      "logErrorLevelMessage": "{0}: ERROREA: {1}",
      "serviceScopeConsumingBeforeFinished": "Ezin dira kontsumitu zerbitzuak esparrua oraindik amaitu ez baita",
      "serviceScopeConsumingDuringAutoCreation": "Ezin dira kontsumitu zerbitzuak ServiceScope funtzioaren sorkuntza automatikoan",
      "serviceScopeAlreadyFinishedError": "Amaitu da ServiceScope funtzioa",
      "serviceScopeProvideServiceAfterFinishedError": "Ezin da erregistratu zerbitzua esparrua dagoeneko amaitu baita",
      "serviceScopeProvideServiceThatAlreadyExists": "\"{0}\" zerbitzu-gakoa dagoeneko erregistratu da esparru honetan"
    },
    "_nQNACBeQ34aV6bVwtFBayA": {
      "platformFailedToLoadError": "Ezin izan da kargatu plataforma. IDa: \"{0}\". Izena: \"{1}\"",
      "applicationFailedToLoadError": "Ezin izan da kargatu aplikazioa. IDa: \"{0}\". Izena: \"{1}\"",
      "applicationFailedToLoadWithMessageError": "Ezin izan da kargatu aplikazioa. IDa: \"{0}\". Izena: \"{1}\". Errorea \"{2}\"",
      ...
      "missingApplicationIdError": "Aplikazio IDa falta da.",
      ...
      "debugManifestLoadingWarning": "ABISUA: orri honek seguruak ez diren scriptak kargatzeko eskatu du, eta ordenagailuak kalteak jasan ditzake. Ez egin aurrera garatzailearekin fidatzen ez bazara edo arriskuak ulertzen ez badituzu.",
      ...
      "loadComponentError": "Ezin izan da kargatu \"{0}\" osagaia ({1}). Jatorrizko errorea: {2}",
      "loadComponentMaxRetriesError": "\"{0}\" ({1}) osagaia {2} aldiz saiatu da kargatzen, baina saiakerek huts egin dute.",
      "loadComponentDependencyError": "Ezin izan da kargatu \"{0}\" mendekotasuna \"{1}\" osagaitik ({2}).",
