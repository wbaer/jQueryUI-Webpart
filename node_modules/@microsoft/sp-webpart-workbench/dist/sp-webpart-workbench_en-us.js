define("8be81a5c-af38-4bb2-af97-afa3b64dfbed_1.0.0", ["react","react-dom","@microsoft/sp-application-base","@microsoft/sp-loader","office-ui-fabric-react","@microsoft/sp-core-library","@microsoft/sp-client-preview"], function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ function(module, exports, __webpack_require__) {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var sp_application_base_1 = __webpack_require__(4);
		var sp_loader_1 = __webpack_require__(5);
		var ErrorDialog_1 = __webpack_require__(6);
		var Workbench_1 = __webpack_require__(10);
		var PageStore_1 = __webpack_require__(66);
		var spWebpartWorkbench_resx_1 = __webpack_require__(67);
		...
		var SpWebpartWorkbench = (function (_super) {
		    ...
		    SpWebpartWorkbench.prototype.onLoad = function () {
		        ...
		        if (window.ENVIRONMENTTYPE !== 'Local') {
		            sp_loader_1.SPComponentLoader._forceLocalManifests().then(function () {
		                console.debug(spWebpartWorkbench_resx_1.default.SuccessfullyLoadedText); 
		                _this._pageStore.setPageReady();
		            }, function (error) {
		                var errorMessage = spWebpartWorkbench_resx_1.default.ErrorLoadingText.replace(/\{0\}/, error.toString());
		    ...
		    SpWebpartWorkbench.prototype.onRender = function () {
		        ReactDOM.render(React.createElement(Workbench_1.WorkBench, { pageStore: this._pageStore }), this.domElement);
		    };
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var ErrorDialog_resx_1 = __webpack_require__(8);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var WorkbenchCommandBar_1 = __webpack_require__(12);
		var CanvasHost_1 = __webpack_require__(14);
		var MobilePreview_1 = __webpack_require__(24);
		var Workbench_resx_1 = __webpack_require__(62);
		var Workbench_module_scss_1 = __webpack_require__(63);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var WorkbenchCommandBar_resx_1 = __webpack_require__(13);
		        ...
		        var items = this.props.isEditing ? [
		            {
		                ...
		                icon: 'Save',
		                ariaLabel: WorkbenchCommandBar_resx_1.default.SaveAltText,
		            ...
		            },
		            {
		                ...
		                icon: 'RevToggleKey',
		                ariaLabel: WorkbenchCommandBar_resx_1.default.DiscardAltText,
		        ...
		        var farItems = this.props.isEditing ? [
		            {
		                ...
		                icon: 'CellPhone',
		                ariaLabel: WorkbenchCommandBar_resx_1.default.MobleAltText,
		            ...
		            },
		            {
		                ...
		                icon: 'Tablet',
		                ariaLabel: WorkbenchCommandBar_resx_1.default.TabletAltText,
		            ...
		            },
		            {
		                ...
		                icon: 'View',
		                ariaLabel: WorkbenchCommandBar_resx_1.default.PreviewAltText,
		        ...
		        ] : [
		            {
		                ...
		                icon: 'Edit',
		                ariaLabel: WorkbenchCommandBar_resx_1.default.EditAltText,
		                title: WorkbenchCommandBar_resx_1.default.EditAltText,
		                onClick: this.props.toggleEdit,
		                'data-automation-id': 'workbench-command-bar-edit'
		            }
		        ];
		        return React.createElement(office_ui_fabric_react_1.CommandBar, { isSearchBoxVisible: false, items: items, farItems: farItems });
		    };
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var sp_client_preview_1 = __webpack_require__(15);
		var sp_core_library_1 = __webpack_require__(11);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var PropertyPaneController_module_scss_1 = __webpack_require__(16);
		var CanvasHost_module_scss_1 = __webpack_require__(21);
		var CanvasHost = (function (_super) {
		    ...
		    CanvasHost.prototype.componentDidMount = function () {
		        ...
		        this._canvas = new sp_client_preview_1.Canvas(this._canvasElement, canvasOptions);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    canvasHost: 'canvasHost_d6f910b6',
		    belowHeader: 'belowHeader_d6f910b6',
		    content: 'content_d6f910b6',
		    hasHeader: 'hasHeader_d6f910b6',
		    hasCommandBar: 'hasCommandBar_d6f910b6',
		    NavPane: 'NavPane_d6f910b6',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".canvasHost_d6f910b6{position:absolute;left:0;top:0;right:0;bottom:0}.belowHeader_d6f910b6,.content_d6f910b6{position:absolute;top:0;left:0;bottom:0;right:0;overflow:hidden}.content_d6f910b6{transition:margin-right .6s ease;-webkit-transition:margin-right .6s ease;padding:10px 30px;overflow-y:auto}.hasHeader_d6f910b6 .belowHeader_d6f910b6{top:50px}.hasCommandBar_d6f910b6 .content_d6f910b6{top:40px}.canvasHost_d6f910b6 .NavPane_d6f910b6{width:220px;right:auto}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreview_module_scss_1 = __webpack_require__(25);
		var MobilePreviewDevices_1 = __webpack_require__(28);
		var MobilePreviewClickStopBar_1 = __webpack_require__(29);
		var MobilePreviewHeaderBar_1 = __webpack_require__(37);
		var MobilePreviewDeviceView_1 = __webpack_require__(49);
		var MobilePreviewDimensionInput_1 = __webpack_require__(53);
		var MobilePreviewRotate_1 = __webpack_require__(58);
		var DeviceType;
		(function (DeviceType) {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    mobilePreviewContainer: 'mobilePreviewContainer_639541df',
		    mobilePreviewDeviceContainer: 'mobilePreviewDeviceContainer_639541df',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".mobilePreviewContainer_639541df{position:fixed;top:0;bottom:0;left:0;right:0;background:rgba(0,0,0,.87);z-index:2147483647;box-sizing:border-box;padding:0;font-family:'Segoe UI Semilight WestEuropean','Segoe UI Semilight','Segoe UI',Tahoma,Arial,sans-serif}.mobilePreviewDeviceContainer_639541df{position:relative;height:calc(100% - 71px);-webkit-box-align:center;-ms-flex-align:center;align-items:center;overflow:auto;display:-webkit-box;display:-ms-flexbox;display:flex}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreviewClickStopBar_module_scss_1 = __webpack_require__(30);
		var MobilePreviewClickStop_1 = __webpack_require__(33);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    clickStopNavBar: 'clickStopNavBar_71fde46d',
		    navBarItems: 'navBarItems_71fde46d',
		    mobilePreviewDeviceTitle: 'mobilePreviewDeviceTitle_71fde46d',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".clickStopNavBar_71fde46d{height:30px;border-width:0;border-top-width:1px;border-style:solid;box-sizing:content-box;font-size:14px;font-weight:400;margin:0;box-shadow:none;padding:0 10px;width:100%;outline:transparent solid 1px}.navBarItems_71fde46d{display:block;list-style:none;margin:0 7px 0 0;padding:0}.mobilePreviewDeviceTitle_71fde46d{width:200px;margin:auto;text-align:center;padding:4px;position:relative}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreviewClickStop_module_scss_1 = __webpack_require__(34);
		var MobilePreview_1 = __webpack_require__(24);
		var MobilePreviewClickStop = (function (_super) {
		    ...
		    MobilePreviewClickStop.prototype.render = function () {
		        ...
		        var className = office_ui_fabric_react_1.css(MobilePreviewClickStop_module_scss_1.default.navBarItem, 'ms-borderColor-white', MobilePreviewClickStop_module_scss_1.default.clickStop, (_a = {},
		            ...
		            _a));
		        return (React.createElement("div", { className: className, role: 'button', onClick: function () { return _this.props.onClick(_this.props.device); }, style: divStyle }));
		        var _a;
		    };
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    clickStop: 'clickStop_3ab36029',
		    clickStopSelected: 'clickStopSelected_3ab36029',
		    navBarItem: 'navBarItem_3ab36029',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".clickStop_3ab36029{border-width:0;border-left-width:2px;border-right-width:2px;border-style:solid;height:30px;line-height:30px;position:absolute}.clickStop_3ab36029:hover{background-color:#C8C8C8;cursor:pointer}.clickStopSelected_3ab36029{background-color:#C8C8C8}.navBarItem_3ab36029{float:left;margin-right:18px;font-size:14px;padding:0;box-sizing:border-box;display:block}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreviewHeaderBar_module_scss_1 = __webpack_require__(38);
		var MobilePreviewURLEntry_1 = __webpack_require__(41);
		var MobilePreviewDeviceTypeSelector_1 = __webpack_require__(45);
		var MobilePreviewHeaderBar = (function (_super) {
		    ...
		    MobilePreviewHeaderBar.prototype.render = function () {
		        ...
		        return (React.createElement("div", { className: mobilePreviewNavBar },
		            React.createElement("ul", { className: navBarItems },
		                React.createElement("li", { className: navBarItemSmClass },
		                    React.createElement("span", { className: MobilePreviewHeaderBar_module_scss_1.default.mobilePreviewTitle }, "Mobile Preview")),
		                React.createElement("li", { className: navBarItemMdClass }, mobilePreviewURLEntry),
		                React.createElement("div", { className: 'ms-Grid-col ms-u-sm6 ms-u-md6 ms-u-lg3' },
		                    React.createElement("li", { className: navBarItemRightClass },
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    mobilePreviewNavBar: 'mobilePreviewNavBar_bbd8045a',
		    navBarItems: 'navBarItems_bbd8045a',
		    navBarItem: 'navBarItem_bbd8045a',
		    navBarItemRight: 'navBarItemRight_bbd8045a',
		    mobilePreviewTitle: 'mobilePreviewTitle_bbd8045a',
		    mobilePreviewXIcon: 'mobilePreviewXIcon_bbd8045a',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".mobilePreviewNavBar_bbd8045a{height:50px;font-size:14px;font-weight:400;box-sizing:border-box;margin:0;box-shadow:none;padding:0 10px;width:100%;outline:transparent solid 1px}.navBarItems_bbd8045a{display:block;list-style:none;margin:0 7px 0 0;padding:0}.navBarItem_bbd8045a{margin-right:0;float:left;font-size:14px;padding:0;box-sizing:border-box;display:block;height:40px;line-height:40px;position:relative}.navBarItemRight_bbd8045a{float:right;margin:0}.mobilePreviewTitle_bbd8045a{line-height:50px;margin-left:15px;font-size:xx-large}.mobilePreviewXIcon_bbd8045a{font-size:30px;border-left-width:1px;margin:auto;margin-left:30px;line-height:50px}.mobilePreviewXIcon_bbd8045a:hover{cursor:pointer;color:#767676}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreviewURLEntry_module_scss_1 = __webpack_require__(42);
		var MobilePreviewURLEntry = (function (_super) {
		    ...
		    MobilePreviewURLEntry.prototype.render = function () {
		        return (React.createElement("div", { className: MobilePreviewURLEntry_module_scss_1.default.mobilePreviewURLbar },
		            React.createElement(office_ui_fabric_react_1.TextField, { className: MobilePreviewURLEntry_module_scss_1.default.mobilePreviewTextfield, placeholder: 'Enter a URL to view in Mobile Preview', onChanged: this._validateAndCompleteURL }),
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    mobilePreviewURLbar: 'mobilePreviewURLbar_33744742',
		    mobilePreviewTextfield: 'mobilePreviewTextfield_33744742',
		    mobilePreviewURLbutton: 'mobilePreviewURLbutton_33744742',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".mobilePreviewURLbar_33744742{height:100%;padding:5px;width:100%}.mobilePreviewTextfield_33744742{position:absolute;left:0;width:calc(100% - 135px)}.mobilePreviewURLbutton_33744742{position:absolute;right:0;margin:6px;background-color:#C8C8C8;border:1px solid #C8C8C8;border-radius:2px;top:4px}.mobilePreviewURLbutton_33744742:hover{background-color:#A6A6A6}.mobilePreviewURLbutton_33744742:active{background-color:#C8C8C8;border:1px solid #A6A6A6}.mobilePreviewURLbutton_33744742:focus{background-color:#C8C8C8;border:1px solid #A6A6A6}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreviewDeviceTypeSelector_module_scss_1 = __webpack_require__(46);
		var MobilePreview_1 = __webpack_require__(24);
		var MobilePreviewDeviceTypeSelector = (function (_super) {
		    ...
		    MobilePreviewDeviceTypeSelector.prototype.render = function () {
		        ...
		        return (React.createElement("div", null,
		            React.createElement("li", { className: MobilePreviewDeviceTypeSelector_module_scss_1.default.navBarItemRight },
		                React.createElement("a", { role: 'button', onClick: function () { return _this.props.onChangeDeviceType(MobilePreview_1.DeviceType.Phone); } },
		                    React.createElement("span", { className: spanClassNameMobile }))),
		            React.createElement("li", { className: MobilePreviewDeviceTypeSelector_module_scss_1.default.navBarItemRight },
		                React.createElement("a", { role: 'button', onClick: function () { return _this.props.onChangeDeviceType(MobilePreview_1.DeviceType.Tablet); } },
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    mobilePreviewDeviceIcon: 'mobilePreviewDeviceIcon_8ee68c1a',
		    navBarItemRight: 'navBarItemRight_8ee68c1a',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".mobilePreviewDeviceIcon_8ee68c1a{margin:auto;padding:auto;font-size:40px;line-height:50px}.mobilePreviewDeviceIcon_8ee68c1a:hover{cursor:pointer;color:#767676}.navBarItemRight_8ee68c1a{font-size:14px;padding:0;box-sizing:border-box;display:block;height:40px;line-height:40px;position:relative;float:right;margin:0}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreviewDeviceView_module_scss_1 = __webpack_require__(50);
		var MobilePreview_1 = __webpack_require__(24);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    mobilePreviewDevice: 'mobilePreviewDevice_a6356aad',
		    mobilePreviewPortrait: 'mobilePreviewPortrait_a6356aad',
		    mobilePreviewLandscape: 'mobilePreviewLandscape_a6356aad',
		    mobilePreviewTablet: 'mobilePreviewTablet_a6356aad',
		    mobilePreviewIframe: 'mobilePreviewIframe_a6356aad',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".mobilePreviewDevice_a6356aad{border-radius:15px;border-style:solid;position:relative;margin:auto;margin-top:70px}.mobilePreviewPortrait_a6356aad{border-width:60px 16px}.mobilePreviewLandscape_a6356aad{border-width:16px 60px}.mobilePreviewTablet_a6356aad{border-width:40px 40px}.mobilePreviewIframe_a6356aad{width:100%;height:100%;position:absolute;border:none}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreviewDimensionInput_module_scss_1 = __webpack_require__(54);
		var MobilePreviewDimensionInput_resx_1 = __webpack_require__(57);
		    ...
		    MobilePreviewDimensionInput.prototype.render = function () {
		        ...
		        return (React.createElement("div", null,
		            React.createElement("div", { className: xContainerClassName },
		                React.createElement("label", { className: labelsClass }, MobilePreviewDimensionInput_resx_1.default.XDimension),
		                React.createElement("input", { className: textfieldsClass, onChange: this.props.onChangedX, value: this.props.currentDevice.width.toString() })),
		            React.createElement("div", { className: yContainerClassName },
		                React.createElement("label", { className: labelsClass }, MobilePreviewDimensionInput_resx_1.default.YDimension),
		                React.createElement("input", { className: textfieldsClass, onChange: this.props.onChangedY, value: this.props.currentDevice.height.toString() }))));
		    };
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    xField: 'xField_40d61663',
		    yField: 'yField_40d61663',
		    mobilePreviewTextfieldXY: 'mobilePreviewTextfieldXY_40d61663',
		    xyTextfields: 'xyTextfields_40d61663',
		    xyLabels: 'xyLabels_40d61663',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".xField_40d61663{left:15px}.yField_40d61663{left:95px}.mobilePreviewTextfieldXY_40d61663{margin:10px;position:absolute;top:15px;width:72px}.mobilePreviewTextfieldXY_40d61663 .xyTextfields_40d61663{position:absolute;min-width:20px;width:50px;right:0;height:25px;box-sizing:border-box;margin:0;box-shadow:none;border:1px solid;font-size:12px;padding:6px 10px 8px;outline:0}.mobilePreviewTextfieldXY_40d61663 .xyLabels_40d61663{position:absolute;font-size:20px;left:0;padding:0;font-weight:400;margin:0;box-shadow:none;box-sizing:border-box;display:block}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React = __webpack_require__(2);
		var office_ui_fabric_react_1 = __webpack_require__(7);
		var MobilePreviewRotate_module_scss_1 = __webpack_require__(59);
		var MobilePreview_1 = __webpack_require__(24);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    mobilePreviewRotateIcon: 'mobilePreviewRotateIcon_57c02c2a',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".mobilePreviewRotateIcon_57c02c2a{position:absolute;right:30px;top:15px;font-size:50px;margin:5px;cursor:pointer;font-weight:100}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var styles = {
		    workbench: 'workbench_917619b0',
		    header: 'header_917619b0',
		    headerMenu: 'headerMenu_917619b0',
		    headerTitle: 'headerTitle_917619b0',
		    headerPerson: 'headerPerson_917619b0',
		    pageContent: 'pageContent_917619b0',
		    commandBar: 'commandBar_917619b0',
		};
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = styles;
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".workbench_917619b0{position:absolute;top:0;right:0;bottom:0;left:0;overflow-x:hidden}.header_917619b0{background:#000;height:50px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:default}.headerMenu_917619b0{background-color:#0075C7;color:#fff;font-size:30px;height:50px;left:0;line-height:50px;position:absolute;text-align:center;top:0;width:50px}.headerTitle_917619b0{color:#fff;left:66px;line-height:50px;position:absolute;top:0}.headerTitle_917619b0 em{border-right:1px solid #666;font-style:normal;margin-right:12px;padding-right:20px}.headerPerson_917619b0{background-color:#A6A6A6;border-left:5px solid #b6cfd8;color:#fff;font-size:48px;height:50px;line-height:50px;position:absolute;right:0;text-align:center;width:50px}.pageContent_917619b0{border:1px solid #e5e5e5;border-bottom:0;bottom:0;margin:0 auto;max-width:924px;position:absolute;top:106px}html[dir=ltr] .pageContent_917619b0{transition:right 367ms cubic-bezier(.1,.9,.2,1);-webkit-transition:right 367ms cubic-bezier(.1,.9,.2,1)}html[dir=rtl] .pageContent_917619b0{transition:left 367ms cubic-bezier(.1,.9,.2,1);-webkit-transition:left 367ms cubic-bezier(.1,.9,.2,1)}html[dir=ltr] .pageContent_917619b0{left:16px}html[dir=rtl] .pageContent_917619b0{right:16px}html[dir=ltr] .pageContent_917619b0{right:16px}html[dir=rtl] .pageContent_917619b0{left:16px}html[dir=ltr] .commandBar_917619b0{transition:padding-right 367ms cubic-bezier(.1,.9,.2,1);-webkit-transition:padding-right 367ms cubic-bezier(.1,.9,.2,1)}html[dir=rtl] .commandBar_917619b0{transition:padding-left 367ms cubic-bezier(.1,.9,.2,1);-webkit-transition:padding-left 367ms cubic-bezier(.1,.9,.2,1)}html[dir=ltr] .commandBar_917619b0{padding-right:0}html[dir=rtl] .commandBar_917619b0{padding-left:0}", ""]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		// module
		exports.push([module.id, ".SPPageChrome-app{top:0!important;height:100%!important}", ""]);
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function() {
	  var strings = {
	    ...
	    "_nCtJlVOXBHa59LgYtajnjA": {
	      "Save": "Save",
	      "SaveAltText": "***Save the current workbench state.",
	      "Discard": "Discard",
	      "DiscardAltText": "***Discard the current workbench state.",
	      "Mobile": "Mobile",
	      "MobleAltText": "***Open the mobile preview tool for a cell phone.",
	      "Tablet": "Tablet",
	      "TabletAltText": "***Open the mobile preview tool for a tablet.",
	      "Preview": "Preview",
	      "PreviewAltText": "***Leave edit mode.",
	      "Edit": "Edit",
	      "EditAltText": "***Enter edit mode."
	    },
	    "_DUar2rjv80IV+Gm5DFIjaA": {
	      "XDimension": "X:",
	      "YDimension": "Y:"
	    }
	  };
